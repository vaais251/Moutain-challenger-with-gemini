...
const GuideProfile: React.FC<{ guide: Guide }> = ({ guide }) => (
    <div className="bg-brand-base rounded-lg shadow-lg overflow-hidden text-center">
        <img src={guide.image} alt={guide.name} className="w-full h-80 object-cover" />
        <div className="p-6">
            <h3 className="text-2xl font-bold font-heading text-white">{guide.name}</h3>
            <p className="text-brand-accent font-semibold mt-1">{guide.role}</p>
            <p className="text-brand-muted mt-4 text-sm">{guide.bio}</p>
        </div>
    </div>
);
        ...
        <div className="bg-brand-dark pt-16 text-brand-light">
            <div className="relative bg-cover bg-center h-80" style={{ backgroundImage: "url('https://picsum.photos/seed/team-banner/1920/600')" }}>
                <div className="absolute inset-0 bg-hero-gradient flex flex-col items-center justify-center text-center p-4">
                    <h1 className="text-5xl md:text-6xl font-extrabold font-heading uppercase text-white">Our Story</h1>
            ...
            <div className="container mx-auto px-4 py-20">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div>
                        <h2 className="text-4xl font-bold font-heading uppercase text-white border-l-4 border-brand-accent pl-4 mb-6">The Spirit of the Challenge</h2>
                        <p className="text-lg leading-relaxed text-brand-light mb-4">
            ...
            <div className="bg-brand-base py-20">
                <div className="container mx-auto px-4">
                    <h2 className="text-4xl font-extrabold font-heading uppercase text-center text-white mb-16">Meet Our Expert Guides</h2>
