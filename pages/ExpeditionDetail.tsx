...
const ExpeditionDetail: React.FC = () => {
        ...
        return (
            <div className="flex items-center justify-center h-screen bg-brand-primary text-white">
                <div className="text-center">
                    <h1 className="text-4xl font-bold">Expedition Not Found</h1>
                    <p className="mt-4">The adventure you're looking for seems to be off the map.</p>
                    <Link to="/expeditions" className="mt-8 inline-block rounded-md bg-brand-accent px-6 py-3 font-semibold text-brand-primary">Back to Expeditions</Link>
                </div>
            </div>
        );
    }
    ...
    return (
        <>
            <div className="bg-brand-primary text-brand-light pt-16">
                <div className="relative h-96 bg-cover bg-center" style={{ backgroundImage: `url(${expedition.gallery[0]})` }}>
                    <div className="absolute inset-0 bg-black/50 flex items-center justify-center">
                        <div className="text-center text-white p-4">
                            <h1 className="text-5xl md:text-6xl font-extrabold tracking-tight">{expedition.name}</h1>
                ...
                <div className="container mx-auto px-4 py-16">
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                        <div className="lg:col-span-2">
                            <h2 className="text-3xl font-bold text-white mb-4 border-l-4 border-brand-accent pl-4">Overview</h2>
                            <p className="text-lg leading-relaxed text-gray-300">{expedition.longDescription}</p>

                            <h2 className="text-3xl font-bold text-white mt-12 mb-6 border-l-4 border-brand-accent pl-4">Route Map</h2>
                            <img src="https://picsum.photos/seed/map/1200/400" alt="Trek map" className="rounded-lg shadow-lg w-full" />


                            <h2 className="text-3xl font-bold text-white mt-12 mb-6 border-l-4 border-brand-accent pl-4">Day-by-Day Itinerary</h2>
                            ...
                            <h2 className="text-3xl font-bold text-white mt-12 mb-4 border-l-4 border-brand-accent pl-4">Photo Gallery</h2>
                        ...
                        <div className="lg:col-span-1">
                            <div className="sticky top-24 bg-brand-secondary p-8 rounded-lg shadow-xl">
                                <h3 className="text-2xl font-bold text-white mb-6">Trip Details</h3>
                                ...
                                <button 
                                    ...
                                    className="mt-8 w-full transform rounded-md bg-brand-accent px-8 py-3 text-lg font-semibold text-brand-primary shadow-lg transition hover:-translate-y-1 hover:bg-yellow-400"
                                >
                                    Enquire Now
                                </button>
                            </div>
