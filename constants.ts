...
export const EXPEDITIONS: Expedition[] = [
  {
    ...
    itinerary: [
      { day: 1, title: 'Arrival in Islamabad', description: 'Transfer to hotel and briefing.' },
      { day: 2, title: 'Fly to Skardu', description: 'A scenic flight to the gateway of the Karakoram.' },
      { day: 3, title: 'Acclimatization in Skardu', description: 'Prepare for the trek and explore the local area.' },
      { day: 6, title: 'Drive to Askole', description: 'The last village before entering the wilderness.' },
      { day: 7, title: 'Trek to Concordia', description: 'Trekking along the mighty Baltoro Glacier.' },
      { day: 13, title: 'K2 Base Camp Excursion', description: 'A day trip to the base camp of K2.' },
      { day: 14, title: 'Cross Gondogoro La', description: 'The challenging pass crossing into the Hushe Valley.' },
      { day: 17, title: 'Trek to Hushe', description: 'Descending through the beautiful Hushe Valley.' },
      { day: 20, title: 'Drive to Skardu', description: 'Return to civilization.' },
      { day: 21, title: 'Fly to Islamabad / Departure', description: 'Fly back to Islamabad for your journey home.' },
    ],
  ...
  },
  {
    ...
    itinerary: [
      { day: 1, title: 'Arrival in Islamabad', description: 'Transfer to hotel.' },
      { day: 2, title: 'Drive to Chilas', description: 'Travel along the famous Karakoram Highway.' },
      { day: 3, title: 'Drive to Raikot Bridge & Jeep to Tattu', description: 'Begin the adventure towards Fairy Meadows.' },
      { day: 4, title: 'Trek to Fairy Meadows', description: 'A short trek to the iconic viewpoint.' },
      { day: 5, title: 'Explore Nanga Parbat Base Camp (Raikot Face)', description: 'Day hike to the base camp.' },
      { day: 6, title: 'Return to Tattu and drive to Astore', description: 'Journey to the other side of the mountain.' },
      { day: 7, title: 'Drive to Tarashing', description: 'The starting point for the Rupal Face trek.' },
      { day: 8, title: 'Trek to Herligkoffer Base Camp (Rupal Face)', description: 'Experience the sheer south face of Nanga Parbat.' },
      { day: 10, title: 'Return to Tarashing', description: 'Trek back.' },
      { day: 11, title: 'Drive to Gilgit', description: 'Explore the capital of Gilgit-Baltistan.' },
      { day: 12, title: 'Drive to Besham', description: 'Continue the journey back on the KKH.' },
      { day: 13, title: 'Drive to Islamabad', description: 'Return to the capital city.' },
  ...
  },
  {
    ...
    itinerary: [
        { day: 1, title: 'Arrival in Islamabad', description: 'Welcome and transfer to hotel.' },
        { day: 2, title: 'Fly to Gilgit, Drive to Hunza', description: 'A scenic flight and drive to Karimabad.' },
        { day: 3, title: 'Explore Karimabad', description: 'Visit Baltit and Altit Forts.' },
        { day: 4, title: 'Trek to Ultar Meadows', description: 'A day hike with spectacular views of Ultar Sar.' },
        { day: 5, title: 'Visit Attabad Lake & Passu', description: 'See the iconic blue lake and Passu Cones.' },
        { day: 6, title: 'Hike on Passu Glacier', description: 'A gentle glacier walk.' },
        { day: 7, title: 'Explore Gojal Valley', description: 'Visit Hussaini Suspension Bridge.' },
        { day: 8, title: 'Drive back to Gilgit', description: 'Time for souvenir shopping.' },
        { day: 9, title: 'Fly to Islamabad', description: 'Return flight to the capital.' },
        { day: 10, title: 'Departure', description: 'End of the tour.' },
    ],
