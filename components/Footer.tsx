...
const Footer: React.FC = () => {
  return (
    <footer className="bg-brand-base border-t border-gray-700">
          ...
          <div className="grid grid-cols-2 gap-8 lg:col-span-2 sm:grid-cols-3">
            <div>
              ...
              <nav className="mt-4 flex flex-col space-y-2">
                {NAV_LINKS.map(link => (
                  <Link key={link.path} to={link.path} className="text-brand-muted transition hover:text-brand-accent">
                    {link.label}
                  </Link>
                ))}
              </nav>
            ...
            <div>
              ...
              <nav className="mt-4 flex flex-col space-y-2">
                <a href="#" className="text-brand-muted transition hover:text-brand-accent">Terms & Conditions</a>
                <a href="#" className="text-brand-muted transition hover:text-brand-accent">Privacy Policy</a>
                <a href="#" className="text-brand-muted transition hover:text-brand-accent">Booking Policy</a>
              </nav>
            </div>
            <div>
              <p className="font-semibold text-white">Contact Us</p>
              <ul className="mt-4 space-y-2 text-sm">
                <li className="text-brand-muted">Email: info@mountainchallenger.com</li>
                <li className="text-brand-muted">Phone: +92 123 4567890</li>
                <li className="text-brand-muted">Address: Skardu, Gilgit-Baltistan, Pakistan</li>
              </ul>
            </div>
          </div>
        </div>
